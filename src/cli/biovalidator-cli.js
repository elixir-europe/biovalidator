...
const BioValidator2 = require("../biovalidator");

class BioValidatorCLI2 {
    ...
    validate() {
        ...
        let biovalidator = new BioValidator2("/home/isuru/Projects/biovalidator/test/resources/schema_dir/*.json");
...
module.exports = BioValidatorCLI2;
